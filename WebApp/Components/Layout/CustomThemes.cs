...
public class CustomThemes
{
    ...
    public static MudTheme AiSearchExample()
    {
        var theme = new MudTheme()
        {
            PaletteLight = _lightPalette_AiSearchExample,
            PaletteDark = _darkPalette_AiSearchExample,
            LayoutProperties = new LayoutProperties()
        };
        return theme;
    }
    public static MudTheme EUCStoreDefaultTheme()
    {
        return new()
        {
    ...
    private static readonly PaletteLight _lightPalette_AiSearchExample = new()
    {
        Black = "#110e2d",
        AppbarText = "#424242",
    ...
    private static readonly PaletteDark _darkPalette_AiSearchExample = new()
    {
        Primary = "#7e6fff",
        Surface = "#1e1e2d",
        Background = "#1a1a27",
